...
if (isset($_GET['id'])) {
  ...
  $message = "ID invalide ou non spécifié";
}
...
<body>
  ...
  <body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
      <h1 class="text-2xl font-bold mb-6 text-red-600">Supprimer un Étudiant</h1>
      <?php if (isset($message)) : ?>
      <p class="mb-4 text-center text-red-500"><?= htmlspecialchars($message); ?></p>
      <?php endif; ?>
      <script type="text/javascript">
      // Redirige vers la page d'accueil après 3 secondes
      setTimeout(function() {
