...
<body class="bg-gradient-to-r from-blue-400 via-cyan-400 to-teal-400 min-h-screen flex items-center justify-center mt-20 mb-20">
  <div class="bg-white p-10 rounded-2xl shadow-2xl w-full max-w-md">
    ...
    <form class="space-y-5">
      ...
      <div>
        <label class="block mb-1 text-sm font-medium text-gray-700">confirmation du  passe</label>
        <input type="password" class="w-full px-4 py-2 border rounded-xl shadow-sm focus:ring-2 focus:ring-teal-500 outline-none">
      </div>
      <div class="flex items-center justify-between">
        ...
        <a href="remembat.php" class="text-sm text-teal-600 hover:underline">Mot de passe oublié ?</a>
      </div>
